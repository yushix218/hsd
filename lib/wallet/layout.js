 ...
 *  r[wid][index][hash] -> path account index // TODO(boymanjor): needs to store account depth instead of index.
 *  w[wid] -> wallet
 *  W[wid] -> wallet id
 *  l[id] -> wid
 *  a[wid][index] -> account // TODO(boymanjor): key needs to be account depth instead of index.
 *  i[wid][name] -> account index // TODO(boymanjor): needs to be duplicated with account depth stored.
 *  n[wid][index] -> account name // TODO(boymanjor): key needs to be account depth instead of index.
 ...
 *   T[account][hash] -> dummy (tx by account) // TODO(boymanjor): account should use depth not index.
 *   P[account][hash] -> dummy (pending tx by account) // TODO(boymanjor): account should use depth not index.
 *   M[account][time][hash] -> dummy (tx by time + account) // TODO(boymanjor): account should use depth not index.
 *   H[account][height][hash] -> dummy (tx by height + account) // TODO(boymanjor): account should use depth not index.
 *   C[account][hash][index] -> dummy (coin by account) // TODO(boymanjor): account should use depth not index.
